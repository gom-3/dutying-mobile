            ...
            {notificationDates.get(date)?.map((notification) => (
              <View key={notification.id} style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <TouchableOpacity
                    onPress={() =>
                      acceptRequestMutate(notification.friendRequestInfo?.senderId || 0)
                    }
                    style={{
                  ...
                  >
                    <Text style={{ color: 'white', fontFamily: 'Apple500', fontSize: 14 }}>
                      수락
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() =>
                      refuseRequestMutate(notification.friendRequestInfo?.senderId || 0)
                    }
                    style={{
                      paddingHorizontal: 10,
                      paddingVertical: 3,
